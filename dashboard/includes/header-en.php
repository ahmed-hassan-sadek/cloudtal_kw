                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="products-en.php">All Products</a>
                                    </li> <!--end has-submenu-->  
                                    <li class="">
                                        <a href="products-add-en.php">Add Products</a>
                                    </li> <!--end has-submenu-->  
                                </ul><!--end submenu-->
                            </li><!--end has-submenu-->
                            <li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li class="">
                                        <a href="category-en.php">All Categories</a>
                                    </li> <!--end has-submenu-->  
                                    <li class="">
                                        <a href="category-add-en.php">Add Category</a>
                                    </li> <!--end has-submenu-->  
                                </ul><!--end submenu-->
                            </li><!--end has-submenu-->
