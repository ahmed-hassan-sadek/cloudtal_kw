					...
					<div class="prd-block_title-wrap">
						<div class="prd-block_reviews" data-toggle="tooltip" data-placement="top" title="Scroll To Reviews"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star"></i>
							<span class="reviews-link"><a href="#" class="js-reviews-link"> (17 reviews)</a></span>
												...
												<h1 class="prd-block_title"><?= $products['english_name'] ?></h1>
					</div>
				</div>
			</div>
			<div class="col-md-auto prd-block-prevnext-wrap">
				<div class="prd-block-prevnext">
	<a href="#"><span class="prd-img"><img class="lazyload fade-up" src=""  alt=""><i class="icon-arrow-left"></i></span></a>
...
<div class="product-previews-wrapper">
	...
	<div class="prd-block_order-info prd-block_info_item " data-order-time="" data-locale="en">
		...
		<div>Your Order will Reach you in 48 hours</div>
	</div>
	...
	<div class="order-0 order-md-100">
		<form method="post" action="#">
			...
			<div class="prd-block_actions prd-block_actions--wishlist">
				...
				<div class="btn-wrap">
					<button name="add" class="btn btn--add-to-cart js-trigger-addtocart js-prd-addtocart" data-product='{"name":  "Leather Pegged Pants ",  "url ": "product.html",  "path ": "images/skins/fashion/product-page/product-01.webp",  "aspect_ratio ": "0.78"}'>buy Now</button>
				</div>
				</form>
			</div>
		</form>
		<div class="prd-block_agreement prd-block_info_item order-0 order-md-100 text-right" data-agree>
			...
			<label for="agreementCheckboxProductPage"><a href="#" data-fancybox class="modal-info-link" data-src="#agreementInfo">accept all services</a></label>
		</div>
	</div>
	<div class="prd-block_info_item">
		<ul class="prd-block_links list-unstyled">
			<li><i class="icon-size-guide"></i><a href="#" data-fancybox class="modal-info-link" data-src="#sizeGuide">all sizes avail</a></li>
			<li><i class="icon-delivery-1"></i><a href="#" data-fancybox class="modal-info-link" data-src="#deliveryInfo">free delivery service</a></li>
			<li><i class="icon-email-1"></i><a href="#" data-fancybox class="modal-info-link" data-src="#contactModal">ask about your needs</a></li>
		</ul>
...
class Buy
{
	public static function BuyProduct()
	{
		...
		$sql = "SELECT id FROM users_products WHERE product_id = '$id'";
		...
		$query = "UPDATE users_products SET counter = '$quantity' WHERE id = '$id'";
		...
		{
			$sql = "SELECT products.id AS id FROM users_products INNER JOIN products ON users_products.product_d = products.id ";
			$id = mysqli_query($conn , $sql);
			$product_id = $id->fetch_assoc();
			?>
