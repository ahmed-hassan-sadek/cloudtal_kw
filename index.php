...
<div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php?id=<?= $last_products['id'] ?>" class="prd-img image-hover-scale image-container">
			...
			<div class="prd-circle-labels">
				<form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
					...
					<button name="add"><a href="#" ><i class="icon-heart-stroke"></i></a><a href="#" title="Remove From Wishlist"></a></button>
					<?php } 
						else {?>
		...
		<div class="prd-info prd-info--pad">
			<div class="prd-info-wrap">
				...
				<div class="prd-tag"><a href="#">shoppingkw</a></div>
				<h2 class="prd-title"><a href="product.html"><?= $last_products['arabic_name'] ?></a></h2>
			...
			<div class="prd-hovers">
				...
				<form method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
					...
					<button name="add"><a href="#" class="circle-label-compare circle-label-wishlist--add js-add-wishlist mt-0" title="Add To Wishlist"><i class="icon-heart-stroke"></i></a><a href="#"><i class="icon-heart-hover"></i></a></button>
					<?php } 
						else { ?>
							<button name="add"><a href="#"><i class="icon-heart-stroke"></i></a><a href="#"><i class="icon-heart-hover"></i></a></button> 
						<?php }
						?>
				</form>
			</div>
				...
				<div class="prd-action">
					<div class="prd-action-left">
						...
						?>
							<input type="hidden" name="product_id" value="<?= $last_products['id'] ?>">
							<input type="hidden" name="user_id" value="<?= $user_id ?>">
							<button name="add-product" class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Khaki/Black", "path":"images/products/product-05.webp", "url":"product.html", "aspect_ratio":0.778}'>أضف منتجك للعربة</button>
							<?php } 
							else
							{?>
								<button name="add-product" class="btn js-prd-addtocart" data-product='{"name": "Fitness Jumpsuit Khaki/Black", "path":"images/products/product-05.webp", "url":"product.html", "aspect_ratio":0.778}'>أضف منتجك للعربة</button>
...
<div class="holder holder-with-bg holder-pb-small bgcolor">
	<div class="container">
		<div class="row">
			<div class="col-sm-11 col-md-13 right-carousel">
				<div class="title-wrap text-center d-none d-sm-block">
				<h1 class="h1-style"><a href="category.php?id=<?= $categories['id'] ?>"><?= $categories['arabic_name'] ?></a></h1>
...
<div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php?id=<?= $products_category['id'] ?>" class="prd-img image-hover-scale image-container">
				<img src="images/products/<?= $products_category['image'] ?>" width="100px"; height ="200px"; alt="Fitness Jumpsuit Khaki/Black" class="js-prd-img lazyload fade-up">
				<div class="shoppingkw-loader"></div>
				<div class="prd-big-circle-labels">
					<?php
		...
		<div class="prd-info prd-info--pad">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">shoppingkw</a></div>
				<h2 class="prd-title"><a href="product-ar.php?id=<?= $products_category['id'] ?>"><?= $products_category['arabic_name'] ?></a></h2>
				<div class="prd-description">
...
<?php } ?>
			...
			<div class="col-sm-7 col-md-5 right-carousel-image">
				<img src="images/banners/<?= $categories['image'] ?>"class="lazyload fade-up" alt="Banner" width="500px" height="650px";>
			</div>
		</div>
	</div>
</div>
...
<div class="holder">
	<div class="container">
		<div class="title-wrap text-center"><h2 class="h1-style">جميع المنتجات</h2>
			<div class="h-sub maxW-825">اسرع! فالكمية محدودة</div>
		</div>
...
<div class="prd ">
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.php?id=<?= $products['id'] ?>" class="prd-img image-hover-scale image-container">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html"><?= $products['arabic_name'] ?></a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
...
<a href="all-products.php">  <button class="btn px-5">جميع المنتجات</button></a>
