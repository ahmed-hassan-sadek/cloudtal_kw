...
{
  $about1 = $product['about1'];
  $about2 = $product['about2'];
  $aboutimg = $product['aboutimg'];
}
?>

<div class="page-content">
    
	<div class="holder mt-0 py-3 py-sm-5 py-md-10 bg-cover lazyload" data-bgset="<?php echo $aboutimg; ?>">
	<div class="container">
		<div class="row">
			<div class="col-11 col-md-9 col-xl-9">
				<div class="page-title-bg py-md-3 py-xl-6">
					<h1><?php echo $about1; ?></h1>
					<p class="d-none d-md-block"><br>
						<?php echo $about2; ?>
                    </p>
				</div>
			</div>
	...
	<div class="container">
		<div class="title-wrap text-center">
			<h2 class="h1-style">لماذا تتسوق معنا؟</h2>
		</div>
					...
					<form action="#">
						<div class="form-inline">
							<div class="form-control-wrap">
								<input type="text" class="form-control" placeholder="اكتب البريد الإلكترونى...">
								<svg preserveAspectRatio="none"><rect x="2" y="2" rx="6" height="100%" width="100%"></rect></svg>
								<span class="bottom"></span>
							</div>
							<button type="submit" class="btn btn--lg">تابع اخر اخبارنا</button>
						</div>
					</form>
				</div>
			</div>
