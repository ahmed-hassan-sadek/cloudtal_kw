...
$data = "SELECT products.id AS id , products.image AS image , products.arabic_name AS arabic_name , products.description AS description , products.price_after AS price_after FROM users_wishes INNER JOIN products ON users_wishes.product_id = products.id WHERE users_wishes.user_id = '$id'";
...
<div class="mobilemenu js-push-mbmenu">
	<div class="mobilemenu-content">
		<div class="mobilemenu-close mobilemenu-toggle">إغلاق</div>
	...
	<div class="container">
		...
		<?php
			...
			<div class="col-md-14 aside">
				<h1 class="mb-3">منتجاتى المفضلة</h1>
				<div class="empty-wishlist js-empty-wishlist text-center py-3 py-sm-5 d-none" style="opacity: 0;">
					<h3>قائمة رغباتك فارغة</h3>
					<div class="mt-5">
						<a href="index.php" class="btn">استمر فى التسوق</a>
					</div>
				</div>
			...
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
							<a href="product.php?id=<?= $products['id'] ?>"><button class="btn">View Full Info</button></a>
					</div>
				</div>
			</div>
		</div>
	...
	public static function deleteWishes()
	{
		...
		if(!empty($request))
		{
			...
			echo '<script type="text/javascript">
				location.replace("account-wishlist.php");
			</script>';
			die(); 
		}
		if(!empty($script))
