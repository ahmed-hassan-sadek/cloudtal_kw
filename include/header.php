...
<div class="dropdn dropdn_account dropdn_fullheight">
	<a href="index-en.php" class="dropdn-link js-dropdn-link" ><i class="fas fa-language"></i><span class="dropdn-link-txt">English</span></a>
</div>                     
                     <!--user account-->
<div class="dropdn dropdn_account dropdn_fullheight">
	<a href="account-login.php" class="dropdn-link js-dropdn-link" data-panel="#dropdnAccount"><i class="icon-user"></i><span class="dropdn-link-txt">
...
<ul class="mmenu mmenu-js">
	<li class="mmenu-item--simple"><a href="index.php" class="active">الرئيسية</a></li>
    <li class="mmenu-item--simple"><a href="about.php" class="">معلومات عنا</a></li>
	<li class="mmenu-item--simple"><a href="#">الاقسام</a>
		<div class="mmenu-submenu">
			<ul class="submenu-list">
               <?php
					...
					<li class="mmenu-item--simple"><a href="category.php?id=<?= $category['id'] ?>" class=""><?= $category['arabic_name'] ?></a></li>
...
<?php
	...
	<li class="mmenu-item--simple"><a href="contact.php" class="">تواصل معنا</a></li>
</ul>
                    </div>
                    <div class="hdr-logo">
                        <a href="index.php" class="logo"><img srcset="images/logo.png" alt="Logo"></a>
                    </div>
...
<div class="search_container_desktop">
	<div class="dropdn dropdn_search dropdn_fullwidth">
		...
		<div class="dropdn-content">
			<div class="container">
				<form method="get" action="search.php" class="search search-off-popular">
					<input name="keyword" value="<?php echo isset($_POST['keyword']) ? $_POST['keyword'] : '' ?>"
 type="text" class="search-input input-empty" placeholder="عن ماذا تبحث؟">
...
<div class="dropdn dropdn_account dropdn_fullheight">
	<a href="account-details.php" class="dropdn-link js-dropdn-link" data-panel="#dropdnAccount"><i class="icon-user"></i><span class="dropdn-link-txt">Account</span></a>
</div>
        </div>
		...
		<div class="mobilemenu-scroll">
			...
			<div class="nav-wrapper show-menu">
				...
				<ul class="nav nav-level-1">
					...
					<li><a href="#">الاقسام<span class="arrow"><i class="icon-angle-right"></i></span></a>
...
<div class="dropdn_language">
	<div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
		...
		<div class="dropdn-content">
			<ul>
				<li class=""><a href="index-en.php"><img src="images/flags/en.html" alt="">English</a></li>
			</ul>
		</div>
	</div>
</div>
		...
		<?php while($products = mysqli_fetch_array($result)) { ?>
			<div class="minicart-prd row">
				<div class="minicart-prd-image image-hover-scale-circle col">
					<a href="product.php?id=<?= $products['id'] ?>"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="images/products/<?= $products['image'] ?>" alt=""></a>
				</div>
				<div class="minicart-prd-info col">
					<div class="minicart-prd-tag">shoppingkw</div>
					<h2 class="minicart-prd-name"><a href="product.php?id=<?= $products['id'] ?>"><?= $products['arabic_name'] ?></a></h2>
				...
				<form action="backend/products.php" method = "POST" enctype = "multipart/form-data">
					...
					<button name="deleteAr"><a href="#" title="Remove From Wishlist"><i class="icon-recycle"></i></a></button>
				</form>
...
<!---------------start minicart ------------------------>
			<div class="minicart-empty js-minicart-empty d-none">
				<div class="minicart-empty-text">السلة الخاصة بك فارغة</div>
			...
			<a href="#" class="minicart-drop-countdown mt-3">
				<div class="countdown-box-full">
					<div class="row no-gutters align-items-center">
						...
						<div class="col">
							<div class="countdown-txt">عند الشراء لأكثر من منتج سوف تحصل على خصم!
							</div>
			...
			<div class="minicart-drop-info d-none d-md-block">
				<div class="shop-feature-single row no-gutters align-items-center">
					...
					<div class="shop-feature-text col"><b>التسوق!</b> استمر فى التسوق معنا للحصول على خصومات أكثر </div>
				</div>
			</div>
		</div>
		<div class="minicart-drop-fixed js-hide-empty">
			...
			<div class="minicart-drop-total js-minicart-drop-total row no-gutters align-items-center">
				<div class="minicart-drop-total-txt col-auto heading-font">الحساب الكلى</div>
				<div class="minicart-drop-total-price col" data-header-cart-total="">$<?=$data['price_after']?></div>
			</div>
			<div class="minicart-drop-actions">
<!--
<a href="cart.php" class="btn btn--md btn--grey"><i class="icon-basket"></i><span>جميع المنتجات فى السلة</span></a>
-->
