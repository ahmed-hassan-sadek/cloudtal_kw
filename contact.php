...
<div class="holder">
	<div class="container">
		<div class="title-wrap text-center">
			<h1 class="h1-style">تواصل معنا</h1>
		</div>
		...
		<div class="row vert-margin">
			<div class="col-sm-9">
                <div class="title-wrap">
                    <h2 class="h1-style">تواصل معنا الان</h2>
	           <div>يمكنك مراسلتنا بشكل أسرع من هنا</div>
</div>
<form class="contact-form" method="post" action="<?php $_SERVER['PHP_SELF'] ?>">
	<div class="form-group">
		<div class="row vert-margin-middle">
			...
			<div class="col-lg">
				<input type="number" name="number" class="form-control form-control--sm" placeholder="رقم الهاتف" required>
			</div>
		</div>
	</div>
	<div class="form-group">
		<div class="row vert-margin-middle">
			<div class="col-lg">
				<input type="text" name="email" class="form-control form-control--sm" placeholder="الإيميل" required>
			</div>
			<div class="col-lg">
				<input type="text" name="subject" class="form-control form-control--sm" placeholder="موضوع الرسالة" required>
			</div>
		</div>
	</div>
	<div class="form-group">
		<textarea class="form-control form-control--sm textarea--height-200" name="message" placeholder="استفسارك" required></textarea>
	</div>
	<button name="send" class="btn" type="submit">إرسال</button>
</form>
            </div>
